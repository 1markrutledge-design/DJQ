...
data = kalshi_get("/trade-api/v2/markets", params={"limit": 500, "status": "active"})
markets = data.get("markets", [])

found = False
for m in markets:
    if "Canas" in m.get("title", "") or "Fatic" in m.get("title", ""):
        found = True
...
if not found:
    print("Could not find the Moro Canas match in the current active markets page.")
