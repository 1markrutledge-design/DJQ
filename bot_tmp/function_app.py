    ...
    try:
        ...
        for f in fills:
            ...
            # 2. Check by ticker pattern
                ...
                ufc_fills.append(f)
            # 3. SPORTS: NBA, NCAA, NFL, etc (must check BEFORE weather patterns)
            elif any(x in ticker for x in ["KXNBA", "KXNCAA", "KXNFL", "KXNHL", "KXMLB", "LALIGA", "KXEPL", "KXSOCCER"]):
        ...
        stats = {
            ...
            "strategies": {
                ...
                "sports": calculate_strategy_stats(sports_fills, "Sports (NBA/NCAA)", is_simulated=False),
            ...
            "chart_data": {
                ...
                "strategy_distribution": [
                    ...
                    {"name": "Sports", "value": round(sum(calculate_fill_pnl(f) for f in sports_fills), 2)},
